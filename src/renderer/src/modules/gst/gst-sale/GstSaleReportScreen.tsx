...
function GstSaleReportScreen({
  ...
  const loadReport = useCallback(async (): Promise<void> => {
    ...
    try {
      setLoading(true)
      const data = await window.api.gstReport.sales({
        ...
        <div className="gst-report-body">
          ...
          <div className="gst-report-toolbar no-print">
            <div className="form-field">
              <label htmlFor="gst-sale-from-date">From Date</label>
              <input
                id="gst-sale-from-date"
                type="date"
                value={fromDate}
            ...
            <div className="form-field">
              <label htmlFor="gst-sale-to-date">To Date</label>
              <input
                id="gst-sale-to-date"
                type="date"
                value={toDate}
            ...
            <div className="form-field">
              <label htmlFor="gst-sale-metal-filter">Metal</label>
              <select
                id="gst-sale-metal-filter"
                value={metalFilter}
            ...
            <div className="list-search">
              <label htmlFor="gst-sale-search">Search</label>
              <input
                id="gst-sale-search"
                value={searchText}
                onChange={(event) => setSearchText(event.target.value)}
                placeholder="Search bill no, customer, GST no"
              />
                  ...
                  <tr>
                    <td colSpan={12} className="empty-row">
                      {searchText
                        ...
                        : 'No sale found for selected range.'}
                    </td>
                  </tr>
                ) : (
          ...
          <div className="screen-help-text no-print">{helpText}</div>
        </div>
      </div>
    </div>
  )
...
export default GstSaleReportScreen
