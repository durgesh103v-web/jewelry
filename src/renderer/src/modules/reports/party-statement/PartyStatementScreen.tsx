...
function getLedgerTypeClass(sourceType: string): string {
  ...
  if (sourceType === 'SALE' || sourceType === 'SALE_PAYMENT' || sourceType === 'PURCHASE_RETURN')
...
function PartyStatementScreen({ onClose }: { onClose: () => void }): React.JSX.Element {
  ...
  const loadReport = useCallback(
    ...
    [selectedAccountId, fromDate, toDate, showAlert]
  )
  ...
  return (
    <div className="accountwise-details-screen party-statement-screen">
        ...
        <div className="accountwise-details-body">
          ...
          <div className="accountwise-details-toolbar party-statement-toolbar no-print">
            <div className="form-field">
              <label htmlFor="party-statement-account-select">Account</label>
              <select
                id="party-statement-account-select"
            ...
            <div className="form-field">
              <label htmlFor="party-statement-from-date">From Date</label>
              <input
                id="party-statement-from-date"
                type="date"
                value={fromDate}
            ...
            <div className="form-field">
              <label htmlFor="party-statement-to-date">To Date</label>
              <input
                id="party-statement-to-date"
                type="date"
                value={toDate}
            ...
            <div className="list-search">
              <label htmlFor="party-statement-search">Search</label>

              <input
                id="party-statement-search"
                value={searchText}
          ...
          <div className="accountwise-details-print-title">
            ...
            <p>
              Account: {report ? report.account.accountName : 'Not selected'} | Period:{' '}
            ...
            <>
              ...
              <div className="accountwise-balance-grid">
                <BalanceBox
                  ...
                  goldFine={report.periodOpeningBalance.goldFine}
                  silverFine={report.periodOpeningBalance.silverFine}
                  cash={report.periodOpeningBalance.cash}
                  bank={report.periodOpeningBalance.bank}
                  anamat={report.periodOpeningBalance.anamat}
                />
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={17} className="empty-row">
                      {searchText
                        ? 'No matching statement entry found.'
          ...
          <div className="screen-help-text no-print">
            Full transaction statement for the selected party across Sale, Purchase, Returns and
            Cash vouchers. Leave From/To Date blank to view the complete history. Nave increases
            balance, Jama decreases balance.
          </div>
        </div>
      </div>
    </div>
