// Single source of truth for all jewellery weight/fine/majuri math.
// Imported by both the main process (services) and the renderer (live preview)
// so the on-screen calculation can never drift from what the backend saves.
